...
const FINGERPRINTS: Array<{ bank: BankHint; patterns: RegExp[] }> = [
...
export function detectBank(text: string): BankHint | null {
  if (!text) return null;
  let best: { bank: BankHint; score: number } | null = null;
